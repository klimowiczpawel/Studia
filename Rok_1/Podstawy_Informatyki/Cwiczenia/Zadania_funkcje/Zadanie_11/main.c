...
/*
    ...
    Napisz program zawieraj¹cy funkcjê, która znajduje (pierwsz¹) najmniejsz¹ liczbê
    dodatni¹ w 50 elementowej tablicy liczb ca³kowitych. Elementy tablicy powinny byæ
