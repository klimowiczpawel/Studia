...
/*
    ...
    Napisz program zawieraj¹cy funkcjê, która oblicza iloczyn liczb dodatnich,
    nieparzystych w 50 elementowej tablicy liczb ca³kowitych. Elementy tablicy powinny byæ
    wygenerowane losowo w programie g³ównym(oraz wyœwietlone na monitorze), a nastêpnie
    zapisane we wskazanym przy uruchomieniu pliku (argument programu) razem z wynikiem
    zwróconym przez funkcjê.
*/
    if(argc==2){
